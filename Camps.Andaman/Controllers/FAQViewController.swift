...
class FAQViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let title_List = ["1. How do I get registered to the summer camp? ","2. What is the maximum age limit to participate in summer camp? ","3. Where exactly is the summer camp conducted?","4. What is the maximum number of camping days? ","5. Which type of food is served during a stay?","6. What can we expect during camping? ","7. What is the size of each summer camp batch? ","8. What does the camper need to bring for camping? ","9. Any preparation or training is required before entering the camp? ","10. When are the program check-in and pick-up times?","11. Whether the participant is allowed to contact their parents inside the camp? ", "What can we expect during camping? " , "What is the background and experience of camp directors? ", "What makes the camp different? ", "Does the camp offer discount? " , "I am concerned about my child. Is the camp director available by phone? ", "What are the types of food served at camp? ", "Will the camp be transporting kids to and from the camp location and another location? ", "Can my camper make own hours in order to attend other activities?  ", "Will camper receive any certificate? ", "Is the camp focused on fun or skill-building? ", "How much camper-to-camper interaction will there be? ", "Are counselors trained or do they just show up to camp the first day?  ", " Is there a camp nurse in attendance?  " , "How does the camp handle food allergies and medication? ","Are sleeping spaces comfortable?  "]
